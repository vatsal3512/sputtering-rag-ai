        ...
        if not api_key:
            ...
            with st.spinner(f"Scanning Vector Database and Grouping aliases for {material_query}..."):
                ...
                try:
                    ...
                    # DATA CLEANING FIX: Capitalize and strip substrate names to fix "Glass" vs "glass"
                    filtered_df['Substrate'] = filtered_df['Substrate'].astype(str).str.title().str.strip()
                    # Remove "Nan" or "Not Specified" substrates from the mode calculation
                    ...
                    if len(filtered_df) > 0:
                        ...
                        with graph_col1:
                            ...
                            fig_sub.update_layout(xaxis_tickangle=-45) # Prevents overlapping labels
